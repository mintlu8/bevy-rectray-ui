...
use bevy_defer::{signals::TypedSignal, Object, signal_ids};
...
pub fn accordion_page(
    ...
    [
        hbox! (commands{
            ...
            child: radio_button! {
                ...
                child: text! {
                    ...
                    system: |recv: Receiver<Invocation>, rot: Ac<Interpolate<Rotation>>| {
                        let index = index;
        ...
        hstack! (commands {
            ...
            signal: receiver::<Invocation>(sig.clone()),
            extra: ScrollParent,
            system: |recv: Receiver<Invocation>, rot: Ac<Interpolate<Opacity>>| {
                if recv.recv().await.equal_to(&index) {
            ...
            child: frame! {
                ...
                signal: receiver::<Invocation>(sig.clone()),
                system: |recv: Receiver<Invocation>, dim: Ac<Interpolate<Dimension>>, sd: Ac<ScrollDimension>| {
                    let index = index;
            ...
            child: rectangle! {
                ...
                child: rectangle! {
                    ...
                    system: |recv: Receiver<Fac<Vec2>>, dim: Ac<Dimension>| {
